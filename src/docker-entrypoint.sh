...
# Use export to override environment variables
export INPUT_OUTPUT_FORMAT=$(strip_template_expressions "${INPUT_OUTPUT_FORMAT}")
export INPUT_ARGS=$(strip_template_expressions "${INPUT_ARGS}")
export INPUT_TEMPLATE=$(strip_template_expressions "${INPUT_TEMPLATE}")
export INPUT_INDENTION=$(strip_template_expressions "${INPUT_INDENTION}")
export INPUT_OUTPUT_METHOD=$(strip_template_expressions "${INPUT_OUTPUT_METHOD}")
export INPUT_OUTPUT_FILE=$(strip_template_expressions "${INPUT_OUTPUT_FILE}")
export INPUT_CONFIG_FILE=$(strip_template_expressions "${INPUT_CONFIG_FILE}")
export INPUT_RECURSIVE=$(strip_template_expressions "${INPUT_RECURSIVE}")
export INPUT_RECURSIVE_PATH=$(strip_template_expressions "${INPUT_RECURSIVE_PATH}")
export INPUT_WORKING_DIR=$(strip_template_expressions "${INPUT_WORKING_DIR}")
export INPUT_ATLANTIS_FILE=$(strip_template_expressions "${INPUT_ATLANTIS_FILE}")
export INPUT_FIND_DIR=$(strip_template_expressions "${INPUT_FIND_DIR}")
export INPUT_GIT_PUSH=$(strip_template_expressions "${INPUT_GIT_PUSH}")
export INPUT_GIT_PUSH_USER_NAME=$(strip_template_expressions "${INPUT_GIT_PUSH_USER_NAME}")
export INPUT_GIT_PUSH_USER_EMAIL=$(strip_template_expressions "${INPUT_GIT_PUSH_USER_EMAIL}")
export INPUT_GIT_COMMIT_MESSAGE=$(strip_template_expressions "${INPUT_GIT_COMMIT_MESSAGE}")
export INPUT_GIT_PUSH_SIGN_OFF=$(strip_template_expressions "${INPUT_GIT_PUSH_SIGN_OFF}")
export INPUT_GIT_SUB_DIR=$(strip_template_expressions "${INPUT_GIT_SUB_DIR}")
export INPUT_FAIL_ON_DIFF=$(strip_template_expressions "${INPUT_FAIL_ON_DIFF}")

# Use defaults if values were stripped or empty (must match action.yml defaults)
export INPUT_OUTPUT_FORMAT="${INPUT_OUTPUT_FORMAT:-markdown table}"
export INPUT_INDENTION="${INPUT_INDENTION:-2}"
export INPUT_OUTPUT_METHOD="${INPUT_OUTPUT_METHOD:-inject}"
export INPUT_OUTPUT_FILE="${INPUT_OUTPUT_FILE:-README.md}"
export INPUT_CONFIG_FILE="${INPUT_CONFIG_FILE:-disabled}"
export INPUT_RECURSIVE="${INPUT_RECURSIVE:-false}"
export INPUT_RECURSIVE_PATH="${INPUT_RECURSIVE_PATH:-modules}"
export INPUT_WORKING_DIR="${INPUT_WORKING_DIR:-.}"
export INPUT_ATLANTIS_FILE="${INPUT_ATLANTIS_FILE:-disabled}"
export INPUT_FIND_DIR="${INPUT_FIND_DIR:-disabled}"
export INPUT_GIT_PUSH="${INPUT_GIT_PUSH:-false}"
export INPUT_GIT_COMMIT_MESSAGE="${INPUT_GIT_COMMIT_MESSAGE:-terraform-docs: automated action}"
export INPUT_GIT_PUSH_SIGN_OFF="${INPUT_GIT_PUSH_SIGN_OFF:-false}"
export INPUT_FAIL_ON_DIFF="${INPUT_FAIL_ON_DIFF:-false}"
